...
def send_start(bot, update):
    ...
    text = "Hey there! My name is Mia X - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Join [Mia Support Group](https://t.me/mia_support) ( @Keralasbots ) if you need any support or help\n\n\
Follow [Mia](https://t.me/Miss_miabot)  if you want to keep up with the news, updates and bot downtime!\n\n\
Made with love by @Marioarus\n\nWant to add me to your group? [Click here!](t.me/Missxmia_bot?startgroup=true)"
